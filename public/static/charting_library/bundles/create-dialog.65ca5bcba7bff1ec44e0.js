  ...
  ["create-dialog"],
  {
      ...
      ;(function () {
        ...
        ;(v.each = v.forEach =
          ...
          (v.contains =
            ...
            v.include =
              function (t, e, n, r) {
                return (
                  k(t) || (t = v.values(t)), ("number" != typeof n || r) && (n = 0), v.indexOf(t, e, n) >= 0
                )
              }),
        ...
        ;(v.isEqual = function (t, e) {
          ...
          (v.isEmpty = function (t) {
            return (
              null == t ||
              (k(t) && (v.isArray(t) || v.isString(t) || v.isArguments(t))
                ? 0 === t.length
                : 0 === v.keys(t).length)
            )
          }),
    ...
    QwKQ: function (t, e, n) {
      ...
      ;(function (r) {
          ...
          constructor({
            ...
            if (p) {
              if (!e.is("input[type=checkbox]"))
                return void o.logError("`$checkbox` need to be input[type=checkbox]")
        ...
        ;($.fn.tvControlCheckbox = (0, i.createTvBlockWithInstance)(
          "tv-control-checkbox",
          function (t, e = {}) {
      ...
      ;(function (t) {
        ...
        ;(o.prototype.isTouch = function () {
            ...
            return (
              e <= 0 ||
                ((this._scroll_target_top =
                  r <= 0
                    ? this._header_height
                    : Math.min((-t * n) / e + this._header_height, this._header_height)),
              ...
              !this._options.vAlignBottom && t < e
                ...
                : "number" == typeof this._stickyBottom &&
                  this.setContentTop(
                    Math.min(
                      0,
                      this._stickyBottom + this._$wrapper.outerHeight() - this._$content.outerHeight()
                    )
                  )
            }
          }),
          ...
          (o.prototype.save = function () {
            return (
              (this._saved = { top: this._$content.position().top, height: this._$content.outerHeight() }),
              this
            )
          }),
          ...
          (o.prototype.fixBottom = function () {
            ...
            if (this._touch) {
              ...
              this._$content.css({
                top: "auto",
                bottom:
                  this._$wrapper.outerHeight() - this._$content.position().top - this._$content.outerHeight()
              })
